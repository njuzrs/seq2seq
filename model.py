...
class Attn(nn.Module):
    ...
    def forward(self, hidden, encoder_outputs):
        ...
        H = hidden.repeat(max_len, 1, 1).transpose(0, 1)  # B * L * V
        attn_energies = self.score(H, encoder_outputs.transpose(0, 1))  # compute attention score B*L
    ...
    def score(self, hidden, encoder_outputs):
        ...
        # remove the padding in attention
        '''
